...
{
    /// <summary>
    /// Security utility class - EXACT COPY from legacy code
    /// Handles TripleDES encryption/decryption for passwords
    /// </summary>
    public class Seguranca
    {
        public static string EncryptTripleDES(string sIn, string sKey = "KEYTOPOS")
        {
            ...
            DES.Key = hashMD5.ComputeHash(ASCIIEncoding.ASCII.GetBytes(sKey));
            //  Set the cipher mode.
            DES.Mode = CipherMode.ECB;
            //  Create the encryptor.
            ICryptoTransform DESEncrypt = DES.CreateEncryptor();
            //  Get a byte array of the string.
            byte[] Buffer = ASCIIEncoding.ASCII.GetBytes(sIn);
            //  Transform and return the string.
            return Convert.ToBase64String(DESEncrypt.TransformFinalBlock(Buffer, 0, Buffer.Length));
        }

        public static string DecryptTripleDES(string sOut, string sKey = "KEYTOPOS")
        {
            sOut = sOut.Replace(" ", "+");
