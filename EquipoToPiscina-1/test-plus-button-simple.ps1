...
Write-Host "🎯 TESTING PLUS BUTTON FAULT TOLERANT FIX - SIMPLE" -ForegroundColor Green
...
if ($taskCardContent -like '*onclick="abrirModalMedicao*') {
...
if ($taskCardContent -notlike '*data-bs-toggle="modal"*') {
...
if ($cardsContent -like '*window.abrirModalMedicao = function*') {
...
if ($cardsContent -like '*FAULT TOLERANT ARCHITECTURE*') {
...
if ($cardsContent -like '*CORE LAYER - NEVER FAILS*') {
...
if ($cardsContent -like '*ENHANCEMENT LAYER - CAN FAIL SAFELY*') {
...
if ($cardsContent -like '*var today = new Date().toISOString().split*') {
...
if ($cardsContent -like '*statusElement.value = statusId*') {
...
if ($cardsContent -like '*typeof $ !== *undefined* && $.fn && $.fn.maskMoney*') {
...
if ($modalContent -like '*id="modal-nova-medicao"*') {
...
if ($modalContent -like '*id="nova-medicao-data"*') {
...
if ($modalContent -like '*id="nova-medicao-status"*') {
...
if ($cardsContent -like '*NivelBacteria*nivelDetritos*') {
...
if ($modalContent -like '*name="nivelDetritos"*') {
