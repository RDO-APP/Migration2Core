...
{
    /// <summary>
    /// FRONTEND INTEGRITY FIX: Enhanced ObraController with guaranteed stage rendering
    /// This is the fixed version that prevents blank pages for Obra 233
    /// </summary>
    [Authorize]
    public class ObraControllerFrontendIntegrityFix : Controller
    {
        private readonly ILogger<ObraController> _logger;
        private readonly IObraService _obraService;
        private readonly IEtapaService _etapaService;

        public ObraControllerFrontendIntegrityFix(ILogger<ObraController> logger, IObraService obraService, IEtapaService etapaService)
        {
            _logger = logger;
