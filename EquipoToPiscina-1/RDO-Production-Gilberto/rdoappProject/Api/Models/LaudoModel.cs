...
namespace rdoappProject.Api.Models
{
    public class LaudoModel
    {
        ...
        public static List<LaudoViewModel> DashboardGrafico(dynamic param)
        {
            ...
            query.OrderByDescending(x => x.lau_id_laudo).ToList().ForEach(laudo => Lista.Add(new LaudoViewModel
            {
                ...
                lau_nr_nivel_cloro = (int)laudo.lau_tp_nivel_cloro,
                lau_nr_ph = (int)laudo.lau_tp_ph,
                lau_nr_alcalinidade = (int)laudo.lau_tp_alcalinidade,
                lau_nr_limpidez = (bool)laudo.lau_tp_limpidez,
                ...
                lau_tp_nivel_detritos = (bool)laudo.lau_tp_nivel_detritos,
        ...
        public static LaudoViewModel Salvar(dynamic param)
        {
            ...
            _laudo.lau_tp_nivel_cloro = param.nivelCloro;
            _laudo.lau_tp_ph = param.NivelPH;
            _laudo.lau_tp_alcalinidade = param.NivelAlcalinidade;
            ...
            _laudo.lau_tp_nivel_detritos = param.bacterias == null ? false : param.bacterias;
        ...
        public static byte[] GerarDocumentoRdo(int idRdo, bool gerarRelatorioFotografico = false)
        {
            ...
            dtItensLaudo.Columns.Add("lau_tp_nivel_detritos");
            dtItensLaudo.Columns.Add("lau_tp_nivel_proliferacao");

            var nivelCloro = _rdo.lau_tp_nivel_cloro;
            var ph = _rdo.lau_tp_ph;
            var alcalinidade = _rdo.lau_tp_alcalinidade;
            ...
            var bacterias = _rdo.lau_tp_nivel_detritos == true ? "Sim" : "Não";
            var proliferacao = _rdo.lau_tp_nivel_detritos == true ? "Sim" : "Não";

            dtItensLaudo.Rows.Add(nivelCloro, ph, alcalinidade, limpidez, superficie, fundo, nivelCloro2, bacterias, proliferacao);
    ...
    public class LaudoViewModel
    {
        ...
        public int lau_nr_nivel_cloro { get; set; }
        public int lau_nr_ph { get; set; }
        public int lau_nr_alcalinidade { get; set; }
        public bool lau_nr_limpidez { get; set; }
        public bool lau_tp_superficie { get; set; }
        public bool lau_tp_fundo { get; set; }
        public bool lau_tp_nivel_cloro_2 { get; set; }
        public bool lau_tp_nivel_detritos { get; set; }
