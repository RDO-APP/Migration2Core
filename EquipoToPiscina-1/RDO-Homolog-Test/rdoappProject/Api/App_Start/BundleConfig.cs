...
namespace rdoappProject.Api.App_Start
{
    public class BundleConfig
    {
        ...
        {
            // Temporarily disable bundling for debugging
            ...
            bundles.Add(new ScriptBundle("~/bundles/app").Include(
                        ...
                        // "~/Assets/Scripts/lib/jquery.dataTables.min.js", // ARQUIVO NÃO EXISTE - COMENTADO
                        ...
                        // "~/Assets/angular/Scripts/angular-router.js", // ARQUIVO NÃO EXISTE - COMENTADO
            ...
            bundles.Add(new ScriptBundle("~/bundles/bootstrap").Include(
                        "~/Assets/Scripts/lib/bootstrap.js")); // Corrigido caminho
            ...
            bundles.Add(new StyleBundle("~/Styles").Include(
                        ...
                        // "~/Assets/angular/Style/toastr.css", // ARQUIVO NÃO EXISTE - COMENTADO
                        // "~/Assets/Style/jquery.scrollbar.css", // CAMINHO INCORRETO - COMENTADO
                        "~/Assets/Styles/jquery.scrollbar.css", // CAMINHO CORRETO
                        "~/Assets/Styles/sortable.css",
                        // "~/Assets/angular/Style/angular-material.min.css", // ARQUIVO NÃO EXISTE - COMENTADO
