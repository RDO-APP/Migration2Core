...
namespace rdoappProject.Api.Models
{
    public class RdoModel
    {
        ...
        public static RdoViewModel Salvar(dynamic param)
        {
            ...
            {
                throw new Exception("N�o � poss�vel gerar um RDO anterior a data inicial da obra.");
            }
            if (_obra != null && _obra.obr_dt_fim != null && _obra.obr_dt_fim != DateTime.MinValue && dataRdo > _obra.obr_dt_fim)
            {
                throw new Exception("N�o � poss�vel gerar um RDO posterior a data final da obra.");
            }
            ...
            {
                throw new Exception("N�o � poss�vel sobrescrever um RDO que j� foi assinado.");
            }
            ...
            {
                _rdo.rdo_id_colaborador = idColaborador; //S� adicionar o colaborador no cadastro do rdo, na edi��o permanecer o usu�rio que criou.
        ...
        public static byte[] GerarDocumentoRdo(int idRdo, bool gerarRelatorioFotografico = false)
        {
            ...
            dtClima.Rows.Add(_rdo.rdo_ds_clima_manha == "b" ? "Bom" : (_rdo.rdo_ds_clima_manha == "r" ? "Ruim" : "N�o Informado"),
                                            _rdo.rdo_ds_clima_tarde == "b" ? "Bom" : (_rdo.rdo_ds_clima_tarde == "r" ? "Ruim" : "N�o Informado"),
                                            _rdo.rdo_ds_clima_noite == "b" ? "Bom" : (_rdo.rdo_ds_clima_noite == "r" ? "Ruim" : "N�o Informado"),
                                            _rdo.rdo_ds_chuva_manha == "m" ? "Muita Chuva" : (_rdo.rdo_ds_chuva_manha == "p" ? "Pouca Chuva" : (_rdo.rdo_ds_chuva_manha == "s" ? "Sem Chuva" : "N�o Informado")),
                                            _rdo.rdo_ds_chuva_tarde == "m" ? "Muita Chuva" : (_rdo.rdo_ds_chuva_tarde == "p" ? "Pouca Chuva" : (_rdo.rdo_ds_chuva_tarde == "s" ? "Sem Chuva" : "N�o Informado")),
                                            _rdo.rdo_ds_chuva_noite == "m" ? "Muita Chuva" : (_rdo.rdo_ds_chuva_noite == "p" ? "Pouca Chuva" : (_rdo.rdo_ds_chuva_noite == "s" ? "Sem Chuva" : "N�o Informado")));
            ...
            {
                dtAssinaturaContratante.Rows.Add("N�o assinado", "N�o assinado", "N�o assinado", "N�o assinado");
            }
            ...
            {
                dtAssinaturaContratada.Rows.Add("N�o assinado", "N�o assinado", "N�o assinado", "N�o assinado");
            }

            foreach (var item in listaAcidentes)
            {
                dtAcidentes.Rows.Add(item.aci_ds_acidente, item.aci_st_afastamento == "s" ? "Sim" : (item.aci_st_afastamento == "n" ? "N�o" : "N�o Informado"));
            }
        ...
        public static byte[] GenerateReport(DataTable dtCargosAgrupados, DataTable dtEquipamentosAgrupados, rdo rdo, DataTable tarefas, DataTable dtClima, DataTable dtAcidentes, DataTable dtAssinaturaContratante, DataTable dtAssinaturaContratada, DataTable dtImagem, bool gerarRelatorioFotografico)
        {
            ...
            ReportViewer.SetParameters(new ReportParameter("ComentarioRdo", rdo.colaborador.obra_colaborador.FirstOrDefault(oc => oc.oco_id_obra == rdo.rdo_id_obra).oco_st_contratante_contratada == "d" ? rdo.rdo_ds_comentario_geracao : rdo.rdo_ds_comentario_assinatura)); //Obter coment�rio contratada
            ...
            ReportViewer.SetParameters(new ReportParameter("AssinaturaContratante", dtAssinaturaContratante.Rows[0].ItemArray[0].ToString().Equals("N�o assinado") ? "" : "Assinado"));
            ReportViewer.SetParameters(new ReportParameter("AssinaturaContratada", dtAssinaturaContratada.Rows[0].ItemArray[0].ToString().Equals("N�o assinado") ? "" : "Assinado"));
        ...
        internal static bool Assinar(dynamic param)
        {
            ...
            {
                throw new Exception("Esse RDO j� foi assinado pela contratada.");
            }
            ...
            {
                throw new Exception("Esse RDO j� foi assinado pela contratante.");
            }
