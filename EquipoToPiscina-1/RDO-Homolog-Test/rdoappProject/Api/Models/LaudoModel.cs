// using Microsoft.Reporting.WebForms; // COMENTADO TEMPORARIAMENTE
using rdoappClass;
using System;
...
namespace rdoappProject.Api.Models
{
    public class LaudoModel
    {
        ...
        {
            // MÉTODO COMENTADO TEMPORARIAMENTE - REQUER REPORTVIEWER
            return new byte[0];
        }
    ...
    public class LaudoViewModel
    {
        ...
        public int lau_tp_alcalinidade { get; set; }
